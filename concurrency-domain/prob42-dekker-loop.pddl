; This tests the "unlock" sequence of dekker's, by having both threads take the
; lock infinitely many times.
...
(define (problem dekker)
    ...
    (:init
        ...
        ;(exit thread010)
        (branch thread010 flag0 thread00 thread00) ; loop
        ...
        ; (exit thread110)
        (branch thread110 flag1 thread10 thread10) ; loop
